      ...
      <main className="flex-1 flex flex-col min-h-screen lg:ml-0">
        ...
        <div className="lg:hidden bg-white/80 backdrop-blur-md border-b border-gray-200 p-4 flex justify-between items-center sticky top-0 z-40">
           <div className="flex items-center gap-2">
              ...
              {/* DÜZELTME: .ai -> .com */}
              <span className="font-bold text-lg text-gray-900">butikmodel.com</span>
           </div>
           <button onClick={() => setIsSidebarOpen(true)} className="p-2 bg-gray-100 rounded-lg text-gray-700">
