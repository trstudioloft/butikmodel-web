...
export default function Sidebar() {
  ...
  const icons = {
    ...
    faceScan: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>, // Basit yüz tarama simülasyonu
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Dijital İkiz (YENİ)", href: "/dashboard/train-model", icon: icons.faceScan }, // YENİ EKLENEN LINK
      ]
    },
    {
      title: "HESAP",
